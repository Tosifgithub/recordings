...
// import 'package:recordings1/features/employee/models/employee.dart';
// import 'package:recordings1/providers/employee_provider.dart';
//
//
// class EmployeeTab extends StatefulWidget {
//   const EmployeeTab({super.key});
...
//               : provider.employees.isEmpty && provider.isLoading
//               ? const Center(child: CircularProgressIndicator())
//               : ListView.builder(
//             padding: const EdgeInsets.all(8.0),
//             controller: _scrollController,
//             itemCount: provider.employees.length + (provider.isLoading ? 1 : 0),
//             itemBuilder: (context, index) {
